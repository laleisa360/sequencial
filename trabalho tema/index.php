...
<html lang="en">
  ...
  <body>
    <body class="bg-color-home"></body>
    <nav class="fundomenu-home navbar navbar-expand-lg">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php">MELU</a>
      ...
      <img src="lindA_CIRCULO.png" style="width:750px !important;">
